...
Write-Host "Logs:     .logs\\backend.log and .logs\\frontend.log" -ForegroundColor Yellow
...
try {
    while ($true) {
        if ($backendProcess.HasExited) {
            Write-Host "Backend stopped unexpectedly. Check .logs\\backend.log" -ForegroundColor Red
            break
        }

        if ($frontendProcess.HasExited) {
            Write-Host "Frontend stopped unexpectedly. Check .logs\\frontend.log" -ForegroundColor Red
            break
        }
